...
import 'package:truemedapp/ui/Screen/MapScreen/dialogue.dart';
...
//   }
  ...
  //       print(
  //           "Returned User info by shared prefrences   ${userLogin.expires} ");
  //       return userLogin;
  //     }
  //   } catch (ex) {
  //     return userLogin;
...
//getting user information from shared pefrences
  ...
  static void showDialogueForFacilityDetail(
    BuildContext context,String phoneNumber,String webUrl
  ) {
    showGeneralDialog(
      ...
      context: context,
      pageBuilder: (_, __, ___) {
        return AlertDalogue(ctx:context,phoneNumber: phoneNumber,webUrl:webUrl);
      },
